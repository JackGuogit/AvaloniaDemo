...
namespace ChatAI.Services
{
    public class OpenAIApiClient
    {
        ...
        public OpenAIApiClient(string apiKey, string? baseUrl = null)
        {
            ...
            _chatClient = _client.GetChatClient("gpt-3.5-turbo"); // 默认模型，可以在请求时覆盖
        }

        public async Task<string?> CreateChatCompletionAsync(List<Models.ChatMessage> messages, string model = "gpt-3.5-turbo")
        {
            try
            {
